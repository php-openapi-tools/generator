...
all-raw: ## The real runs everything, but due to sponge it has to be ran inside DOCKER_RUN ##U##
	$(MAKE) nunit-testing composer-validate syntax-php composer-normalize rector-upgrade cs-fix cs stan unit-testing mutation-testing composer-require-checker composer-unused backward-compatibility-check ## Count: 13
...
contrib-raw: ## The real runs everything, but due to sponge it has to be ran inside DOCKER_RUN ##U##
	$(MAKE) nunit-testing cs-fix cs unit-testing composer-require-checker composer-unused ## Count: 6
...
task-list-ci-all: ## CI: Generate a JSON array of jobs to run on all variations
	@echo "[\"nunit-testing\",\"composer-validate\",\"syntax-php\",\"cs\",\"stan\",\"unit-testing\",\"mutation-testing\",\"composer-require-checker\",\"composer-unused\",\"backward-compatibility-check\"]" ## Count: 10
